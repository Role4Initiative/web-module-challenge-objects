...
console.log('Task 1b =', createMenuItem('pizza', 4.50, 'lunch'))
console.log('Task 1b =', createMenuItem('Lo Mein', 5.50, 'lunch'))
console.log('Task 1b =', createMenuItem('gyro', 5.75, 'lunch'))
...
console.log('Task 6 =', getReviewByIndex(reviews, 8))
